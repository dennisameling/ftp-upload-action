...
var require_FtpContext = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.FTPContext = exports.FTPError = undefined;
...
var require_FileInfo = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.FileInfo = exports.FileType = undefined;
  var FileType;
  (function(FileType2) {
...
var require_parseListMLSD = __commonJS((exports) => {
  ...
  var FileInfo_1 = require_FileInfo();
  function parseSize(value, info2) {
  ...
  var factHandlersByName = {
    ...
    sizd: parseSize,
    unique: (value, info2) => {
      info2.uniqueID = value;
    },
    modify: (value, info2) => {
      info2.modifiedAt = parseMLSxDate(value);
      info2.rawModifiedAt = info2.modifiedAt.toISOString();
    },
    type: (value, info2) => {
      if (value.startsWith("OS.unix=slink")) {
        info2.type = FileInfo_1.FileType.SymbolicLink;
        info2.link = value.substr(value.indexOf(":") + 1);
        return 1;
      }
      switch (value) {
        case "file":
          info2.type = FileInfo_1.FileType.File;
          break;
        case "dir":
          info2.type = FileInfo_1.FileType.Directory;
          break;
        ...
        case "pdir":
          return 2;
        default:
          info2.type = FileInfo_1.FileType.Unknown;
      }
      return 1;
    },
    "unix.mode": (value, info2) => {
    ...
    "unix.ownername": (value, info2) => {
      info2.user = value;
    },
    "unix.owner": (value, info2) => {
      if (info2.user === undefined)
        info2.user = value;
    },
    get "unix.uid"() {
      return this["unix.owner"];
    },
    "unix.groupname": (value, info2) => {
      info2.group = value;
    },
    "unix.group": (value, info2) => {
      if (info2.group === undefined)
        info2.group = value;
    },
    get "unix.gid"() {
  ...
  function parseLine(line) {
    ...
    const info2 = new FileInfo_1.FileInfo(name);
    ...
    for (const fact of facts) {
      ...
      const result = factHandler(factValue, info2);
      if (result === 2) {
        return;
      }
    }
...
var require_parseList = __commonJS((exports) => {
...
var require_ProgressTracker = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ProgressTracker = undefined;
...
var require_StringWriter = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.StringWriter = undefined;
...
var require_transfer = __commonJS((exports) => {
  ...
  async function enterPassiveModeIPv4_forceControlHostIP(ftp) {
    ...
    const hostsAreCompatible = normalizedControlHost === target.host || (0, netUtils_1.isLoopback)(normalizedControlHost) && (0, netUtils_1.isLoopback)(target.host);
      ...
      socket.connect({ port, host, family: ftp.ipFamily }, () => {
        ...
        if (ftp.socket instanceof tls_1.TLSSocket) {
          socket = (0, tls_1.connect)(Object.assign({}, ftp.tlsOptions, {
            socket,
            session: (_a = ftp.tlsSessionStore) !== null && _a !== undefined ? _a : ftp.socket.getSession()
          }));
          socket.on("session", (session) => {
...
var require_Client = __commonJS((exports) => {
  ...
  class Client2 {
    ...
    connectImplicitTLS(host = "localhost", port = 21, tlsOptions = {}) {
      var _a;
      this.ftp.reset();
      tlsOptions.host = (_a = tlsOptions.host) !== null && _a !== undefined ? _a : host;
    ...
    async access(options = {}) {
      ...
      if (useExplicitTLS) {
        const secureOptions = (_a = options.secureOptions) !== null && _a !== undefined ? _a : {};
        secureOptions.host = (_b = secureOptions.host) !== null && _b !== undefined ? _b : options.host;
...
var require_StringEncoding = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
});
...
var require_dist = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.enterPassiveModeIPv6 = exports.enterPassiveModeIPv4 = undefined;
...
async function run() {
  ...
  let port = Number(getInput("port"));
  const secureInput = getInput("secure");
  let localDir = getInput("local_dir");
  let serverDir = getInput("server_dir");
  ...
  try {
    ...
    info(`Successfully connected to server. Starting upload from folder ${localDir}`);
  } catch (err) {
    setFailed(`Error while connecting to the server: ${err}`);
    return;
  }
  try {
    const absRoot = path.resolve(localDir);
    debug2(`Using this root directory: ${absRoot}`);
    for await (const fileObject of getFiles(localDir, absRoot)) {
      const localCurrentDir = fileObject.folder.replace(localDir, "");
      info(`Uploading ${localCurrentDir}/${fileObject.filename}...`);
      const serverFolder = `${serverDir}${localCurrentDir}`;
      debug2(JSON.stringify(fileObject));
    ...
    setFailed(`Error while transferring one or more files: ${err}`);
  }
...
async function retryRequest(callback, isFinalAttempt = false) {
  try {
    ...
    if (e.code >= 400 && e.code <= 499) {
      info("400 level error from server when performing action - retrying...");
      info(e);
      if (e.code === 426) {
        info("Connection closed. This library does not currently handle reconnects");
        throw e;
      }
